...
public class PyramidPuzzleTest {
	@Test
	public void test5() {
		boolean result = executeFromFile(
				"src/main/java/algstudent/pyramid/case5.txt");
	...
	public void test15() {
		boolean result = executeFromFile(
				"src/main/java/algstudent/pyramid/case15.txt");
		assertEquals(true, result);
	}

	/**
	 * Reads the initial pyramid from a text file and creates an object to deal
	 * with the problem
	 * 
