...
public class PasswordGeneratorTest {
	...
	public void test() {
		...
		String consonantPairsPath = "src/main/java/algstudent"
									+ "/passwords/consonant_pairs.txt";

		PasswordGenerator generator = new PasswordGenerator(
				numberOfTotalCharacters, numberOfNonLettersEnds,
				numberOfPasswords, consonantPairsPath);
